...
bool ns2_usb_vendor_control_xfer_cb(uint8_t rhport, uint8_t stage, tusb_control_request_t const *request) {
...
uint8_t const *tud_hid_descriptor_report_cb(uint8_t instance) {
    return ns2_usb_hid_descriptor_report_cb(instance);
}
